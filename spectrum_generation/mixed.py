...
class MixedGen(object):
    ...
    def clean_specs(self):
        ...
        for struc in self.ref_strucs:
            ...
            steps = np.linspace(self.min_angle, self.max_angle, 2001)  # Reduced from 4501
            ...
            domain_size = 25.0
            step_size = (self.max_angle - self.min_angle)/len(steps)
            ...
            # Clean up memory
            del signals, pattern, angles, intensities
    ...
    def mixed_spectrum(self):
        ...
        noise = np.random.normal(0, 0.25, len(steps))
        ...
        # Clean up memory
        del signals, angles, intensities
        return form_signal
